...
activities = {
    ...
    "Gym Class": {
        ...
        "Soccer Team": {
        "description": "Team training and matches to develop soccer skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Volleyball Club": {
        "description": "Practice volleyball techniques and participate in friendly games",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 16,
        "participants": ["ava@mergington.edu", "isabella@mergington.edu"]
    },
    "Painting Workshop": {
        "description": "Explore painting styles and create original artworks",
    ...
    "Debate Society": {
        "description": "Practice argumentation, critical thinking, and public speaking",
